...
fun main() {
    val gas = OutpustResource(id = 1, name = "Gas", amount = 100)
    val mineral = OutpustResource(id = 2, name = "Minerals", amount = 250)
    println("Успех! Вы добыли дополнительное количество минералов: ${mineral.amount + 50}")
    val bonusMineral = OutpustResource(id = 3, name = "Minerals Bonus", amount = mineral.amount + 50)
